    ...
    <div style="display:block;">
        ...
        <div id="right">
            ...
            <div id="sortNav_nav">
                ...
                <a href="?by=top" class="sortNav<?php echo $top_on ?>">COURSE CATAGORIES</a>
				<a href="?by=credits" class="sortNav<?php echo $cred_on ?>">NUMBER CREDITS</a>
                <a href="?by=all" class="sortNav<?php echo $all_on ?>">ALL COURSES</a>
            </div>
