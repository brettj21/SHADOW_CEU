...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = zilom_get_option('woo_sidebar_config', '');
  $left_sidebar = zilom_get_option('woo_left_sidebar', '');
  $right_sidebar = zilom_get_option('woo_right_sidebar', '');

  if(is_shop()){
    $sidebar_layout_config = get_post_meta( $page_id, 'zilom_sidebar_config', true);
    $left_sidebar = get_post_meta($page_id, 'zilom_left_sidebar', true);
    $right_sidebar = get_post_meta($page_id, 'zilom_right_sidebar', true);
              ...
              <?php woocommerce_product_subcategories(); ?>  
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-grid">
                      ...
                      <?php do_action('zilom_woocommerce_active_filter' );  ?>
